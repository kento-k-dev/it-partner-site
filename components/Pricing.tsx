const PLANS = [
  ...
  },
  {
    ...
    price: '33,000円〜',
    unit: '',
    body: '課題整理、方向性整理、サイト構成、AI活用方針、外注前の要件整理などを行います。必要に応じて、進め方や優先順位を整理した簡易メモ・構成案としてお渡しします。',
    highlight: true,
  },
  {
  ...
  },
  {
    ...
    price: '月額55,000円〜',
    unit: '',
    body: '月1〜数回の相談を通じて、IT・Web・AI活用を継続的に支援します。制作後の改善、外注先とのやり取り、業務整理なども含め、都度相談しながら進めたい場合に適しています。',
  },
]
