...
const FAQS = [
  ...
  {
    q: '初回相談は無料ですか？',
    a: 'ご紹介・既存のおつながりのある方に限り、初回30分のご相談は無料で承っています。現状確認や進め方の整理を中心に行い、具体的な提案や調査を伴うご相談は有料にて承ります。',
  },
  {
    q: '制作費の分割払いはできますか？',
    a: '内容や金額に応じて、分割でのお支払いもご相談いただけます。進め方とお支払い条件を事前に確認したうえで、初回ご入金後に着手しています。',
  },
]
